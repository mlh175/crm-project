...
<%--		遍历stageList，依次显示每一个阶段对应的图标--%>
		<c:forEach items="${stageList}" var="stage">
			...
			<%--如果stage处在当前交易前面，则图标显示为ok-circle，颜色显示为绿色--%>
			...
			<%--如果stage出自啊当前交易所处阶段的后面，则图标显示为record，颜色为黑色--%>
			<c:if test="${tran.orderNo<stage.orderNo}">
	...
	<div style="position: relative; top: 0px;">
		...
		<div style="position: relative; left: 40px; height: 30px; top: 70px;">
			...
			<div style="width: 500px;position: relative; left: 200px; top: -20px;"><b>${rean.editBy}&nbsp;&nbsp;</b><small style="font-size: 10px; color: gray;">${tran.editTime}</small></div>
			<div style="height: 1px; width: 550px; background: #D5D5D5; position: relative; top: -20px;"></div>
		</div>
