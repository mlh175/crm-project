...
<body>
	...
	<form class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="hidden" value="29b8ffbf32764fe198bc9dd3b752e05e" id="create-activityId">
				<input type="text" class="form-control" id="create-activityName" value="测试2_2">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="hidden" value="9b924f10d58449c4a0a14c756613efcf" id="create-contactsId">
				<input type="text" class="form-control" id="create-contactsName" value="哇哈2">
			</div>
		</div>
