...
public class ClueController {
    ...
    public Object saveCreateClue(Clue clue, HttpSession session){
       User user = (User) session.getAttribute(Contants.SESSION_USER);
        ...
        try {
            //调用service方法，保存创建方法
            int createClue = clueService.saveCreateClue(clue);
            if (createClue>0){
    ...
    public String detailClue(String id,HttpServletRequest request){
        ...
        List<ClueRemark> remarkList = clueRemarkService.queryClueRemarkForDetailByCueId(id);
    ...
    @ResponseBody
    private Object queryActivityForDetailByNameClueId(String activityName,String clueId){
        //封装参数
